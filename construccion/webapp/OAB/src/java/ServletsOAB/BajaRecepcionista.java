 ...
 * @author Job
 */
public class BajaRecepcionista extends HttpServlet {
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<div class='container'>");
                    ...
                    if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                        out.println("<h2>¿En verdad desea dar de baja a la recepcionista?</h2>");
                            ...
                            out.println("<table>");  
                                ...
                                out.println("</table>");
                                out.println("   <a class='button fit special' href='VerificarBajaRecepcionista?idRecepcionista=" + idRecepcionista + "'>Aceptar</a>");
                                ...
                                out.println("<h1>Puede que la recepcionista seleccionado haya sido dado de baja por otro usuario, verifique que el ID del ciente se encuentre en el link.</h1>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BajaRecepcionista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
