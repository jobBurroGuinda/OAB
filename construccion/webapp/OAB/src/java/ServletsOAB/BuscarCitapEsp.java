 ...
 * @author Job
 */
public class BuscarCitapEsp extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<header>");
                if(privilegioOAB.equals(privRecepcionista) || privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                    out.println("<h2>Buscar citas</h2>");
                    out.println("<form method='POST' action='BusqCitaspEspecialista'>");
                    out.println("<input type='text' id='nomEspecialista' name='nomEspecialista' autocomplete='on' placeholder='Nombre del especialista'>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BuscarCitapEsp.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
