    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Servicios</title>");
                ...
                if(privilegioOAB.equals(privRecepcionista) || privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                    ...
                    if(request.getParameter("nomServicio") != null) {
                        ...
                        servicios = cn.desplegarServiciosCompleto(nomServicio);
                    } 
                    else {
                        servicios = cn.desplegarServiciosCompleto();
                    }
                    sesion.setAttribute("DatosServicio", servicios);
                    int tServicios = servicios.size();
                    out.println("<h2>Buscar servicio</h2>");
                    out.println("<form method='POST' action='VerServicios'>");
                    out.println("<input type='text' id='nomCliente' name='nomServicio' autocomplete='on' placeholder='Introducir nombre' value='"+nomServicio+"' required>");
                    ...
                    out.println("<table>");
                        ...
                        out.println("<tr>");
                            duracionServicio = s.obtenerDuracion(servicios.get(i).getHoraDuracion(), servicios.get(i).getMinDuracion());
                            out.println("   <td>" + servicios.get(i).getDescripcionServ() + "</td>");
                            out.println("   <td>" + duracionServicio + "</td>");
                            out.println("   <td><a class='button special small' href='EditarServicio?idServicio=" + servicios.get(i).getIdServicio() + "'>Editar</a></td>");
                            out.println("   <td><a class='button special small' href='EliminarServicio?idServicio=" + servicios.get(i).getIdServicio() + "'>Eliminar</a></td>");
                        out.println("</tr>");
                        }
                        out.println("</table>");
                    } else{
                        out.println("<h2>El servicio \"" + nomServicio + "\", no se encuentra registrado</h2>");
                        out.println("<h3><a class='button fit' href='AgregarServicio?nomServicio="+ nomServicio +"'>Clic aquí para registrar</a></h3>");
                    }
