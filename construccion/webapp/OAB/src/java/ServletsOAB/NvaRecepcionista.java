 ...
 * @author Job
 */
public class NvaRecepcionista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            String nombreRecepcionista = "";
                if(request.getParameter("nombreRecepcionista") != null) {
                    nombreRecepcionista = request.getParameter("nombreRecepcionista");
                }
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Nueva recepcionista</title>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(NvaRecepcionista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
