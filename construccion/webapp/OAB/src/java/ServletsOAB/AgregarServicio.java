    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Nuevo servicio</title>");
                ...
                if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                    if(request.getParameter("nomServicio") != null) {
                    ...
                    out.println("<form method='POST' action='RegistrarServicio'>");
                        ...
                        out.println("   <input type='text' value='" + nomServicio + "' placeholder='Introduzca una descripción breve del servicio *' name='servicio' id='servicio' required/>");
                        out.println("</div>");
                        out.println("<br/>");
                        out.println("<h4 style='font-weight:bold;'>Duración</h4>");
                        out.println("<h5>Horas</h5><br>");
                        out.println("<div class='row uniform 50%'>");
                        out.println("   <input type='number' value='0' placeholder='Si el servicio dura menos de una hora, puede escribir en este campo el cero *' name='horas' id='horas' required/>");
                        out.println("</div>");
                        out.println("<br/>");
