 ...
 * @author Job
 */
public class BuscarAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Buscar administrador</title>");
                ...
                if(privilegioOAB.equals(privAdmin)){
                    ...
                    out.println("<input type='text' id='nomAdministrador' name='nomAdministrador' autocomplete='on' placeholder='Introducir nombre'>");
                    out.println("<input class='button special' type='submit' value='Buscar'>");
                    out.println("</form>");
                } else {
                    out.println("<h2 style='color: red;'>Usted no tiene permiso para acceder a esta sección de la aplicación</h2>");
                }
                out.println("</header>");
