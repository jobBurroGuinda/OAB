 ...
 * @author Job
 */
public class VerificarBajaEspecialista extends HttpServlet {
    ...
    private int idHorarioTrabajo = 0;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null) {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Baja del especialista</title>");   
                ...
                out.println("<br/>");
                    ...
                    if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                        ...
                        for(int i=0 ; i<tEspecialistas ; i++) {
                            ...
                            idHorarioTrabajo = especialistas.get(i).getIdHorarioTrabajo();
                        }   
                        verificador = cn.bajaEspecialista(idUsuario, idContacto, idHorarioTrabajo);
                        // Si la cita se cancela correctamente...
                        if(verificador != false) {
                            out.println("<h2 style='color:green;'>El especialista seleccionado se dio de baja exitosamente</h2>");
                            out.println("<a class='button fit special' href='VerCitasdHoy'>Regresar a las citas de hoy</a>");
                        }
                        // Si la cita no se pudo cancelar...
                        else {
                            out.println("<h2 style='color:red;'>El especialista no se pudo dar de baja. Intente de nuevo, si persiste el problema contácte al desarrollador de la aplicación.</h2>");
                            out.println("<table>");
                            for(int i=0 ; i<tEspecialistas ; i++){
                            ...
                            out.println("</table>");
                            out.println("<a class='button fit special' href='VerificarBajaEspecialista?idEspecialista=" + idEspecialista + "'>Aceptar</a>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(VerificarBajaEspecialista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
