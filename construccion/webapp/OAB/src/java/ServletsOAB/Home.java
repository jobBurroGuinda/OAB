...
public class Home extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        privilegioOAB = (String)request.getAttribute("Privilegio");
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>AppointpentBook Muse</title>");
                        ...
                        if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                            ...
                            out.println("   <ul>");
                                if(privilegioOAB.equals(privAdmin)){
                                    ...
                                    verifIdentidadAdmin = cn.verificarIdentidadAdministrador(username);
                ...
                Calendar fa = new GregorianCalendar();
                            ...
                            if(privilegioOAB.equals(privRecepcionista) || privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)) {
                                ...
                                if(tCitas >= 1 ) {
                                    out.println("<center><h1 style='font-weight: bold;'>Bienvenid@ " + username + ". Citas de hoy:</h1></center>");
                                    out.println("<br/>");
                                    out.println("<table>");
                                    out.println("<thead>");
                                ...
                                int tCitas = citas.size();
                                if(tCitas >= 1) {
                                    out.println("<center><h1 style='font-weight: bold;'>Bienvenid@ " + username + ". Sus citas de hoy</h1></center>");
                                    out.println("<br/>");
                                    out.println("<table>");
                                    out.println("<thead>");
                                    out.println("<th>Servicio:</th>");
