 ...
 * @author Job
 */
public class BajaAdmin extends HttpServlet {
        ...
        if(sesion != null){
            ...
            if(privilegioOAB.equals(privAdmin)   &&   verifIdentidadAdmin != false) {
                if(request.getParameter("idAdministrador") != null) {
                    ...
                    sesion.setAttribute("DatosAdministrador", administradores);
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<div class='container'>");
                    ...
                    if(privilegioOAB.equals(privAdmin)   &&   verifIdentidadAdmin != false) {
                        out.println("<h2>¿En verdad desea dar de baja al administrador?</h2>");
                            ...
                            out.println("<table>");  
                                ...
                                out.println("</table>");
                                out.println("   <a class='button fit special' href='VerificarBajaAdmin?idAdministrador=" + idAdministrador + "'>Aceptar</a>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BajaAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
