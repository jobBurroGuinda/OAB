 ...
 * @author Job
 */
public class BajaEspecialista extends HttpServlet {
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<div class='container'>");
                    ...
                    if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                        out.println("<h2>¿En verdad desea dar de baja al especialista?</h2>");
                        out.println("<h3 style='color:orange;'>Todas las citas que tiene agendadas se cancelarán</h3>");
                            if(tEspecialistas > 0) {
                            out.println("<table>");  
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BajaEspecialista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
