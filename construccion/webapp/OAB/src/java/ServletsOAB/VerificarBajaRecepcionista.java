 ...
 * @author Job
 */
public class VerificarBajaRecepcionista extends HttpServlet {
                ...
                out.println("<br/>");
                    ...
                    if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                        ...
                        if(verificador != false) {
                            out.println("<h2 style='color:green;'>La recepcionista seleccionada se dio de baja exitosamente</h2>");
                            out.println("<a class='button fit special' href='VerCitasdHoy'>Regresar a las citas de hoy</a>");
                        }
                        // Si la cita no se pudo cancelar...
                        else {
                            out.println("<h2 style='color:red;'>La recepcionista no se pudo dar de baja. Intente de nuevo, si persiste el problema contácte al desarrollador de la aplicación.</h2>");
                            out.println("<table>");
                            for(int i=0 ; i<tRecepcionistas ; i++){
                            ...
                            out.println("</table>");
                            out.println("   <a class='button fit special' href='VerificarBajaRecepcionista?idRecepcionista=" + idRecepcionista + "'>Volver a intentar</a>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(VerificarBajaRecepcionista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
