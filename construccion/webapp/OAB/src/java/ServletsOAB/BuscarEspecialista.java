 ...
 * @author Job
 */
public class BuscarEspecialista extends HttpServlet {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                // Inicio del encabezado
                        ...
                        if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                            ...
                            out.println("   <ul>");
                            out.println("       <li><a href='BuscarCitapCliente'>Buscar por cliente</a></li>");
                ...
                out.println("<header>");
                if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                    out.println("<h2>Buscar datos del especialista</h2>");
                    out.println("<form method='POST' action='BusqEspecialista'>");
                    out.println("<input type='text' id='nomEspecialista' name='nomEspecialista' autocomplete='on' placeholder='Introducir nombre'>");
                ...
                out.println("</header>");
                out.println("<span class='image'><img src='images/pic01.jpg' alt='' /></span>");
                out.println("</div>");
                out.println("<a href='#one' class='goto-next scrolly'>Next</a>");
                out.println("</section>");
                out.println("");
                out.println("");
                out.println("");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BuscarEspecialista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
