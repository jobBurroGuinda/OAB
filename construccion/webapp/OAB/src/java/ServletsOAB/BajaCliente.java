        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<div class='container'>");
                    ...
                    if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                        out.println("<h2>¿En verdad desea dar de baja al cliente?</h2>");
                        out.println("<table>");
                        ...
                        out.println("</table>");
                        out.println("   <a class='button fit special' href='VerificarBajaCliente?idCliente=" + idCliente + "'>Aceptar</a>");
