...
INSERT INTO `cservicio` (`idS_srv`,`des_srv`,`dur_srv`) VALUES 
 (1,'Tinte','00:30:00'),
 (2,'Corte caballero','00:20:00'),
 (3,'Depilación de barba','00:40:00');
...
INSERT INTO `dcita` (`idI_cta`,`hra_cta`,`fch_cta`,`idL_cta`,`idS_cta`,`idE_cta`) VALUES 
 (116,'17:00:00','2016-07-11',1,1,8),
 (117,'15:05:00','2016-07-11',18,1,8),
 (118,'17:00:00','2016-07-12',49,1,8),
 (119,'17:00:00','2016-08-02',18,1,8),
 (121,'17:35:00','2016-08-02',2,1,8),
 (122,'18:00:00','2016-08-01',16,3,8),
 (123,'16:00:00','2016-08-01',48,2,7),
 (124,'13:00:00','2016-08-01',48,3,8);
...
INSERT INTO `dcontacto` (`idC_con`,`tel_con`,`mal_con`,`fbk_con`) VALUES 
 ...
 (5,'4437885379','raul@gmail.com','Raúl Estetica'),
 ...
 (10,'2133435292','logo.foco@gmail.mx','Meni Coto Leno 2'),
 ...
 (21,'2345678912','a@llll','kkk'),
 (22,'2345678912','a@llll','kkk'),
 (23,'2345678912','a@llll','kkk');
INSERT INTO `dcontacto` (`idC_con`,`tel_con`,`mal_con`,`fbk_con`) VALUES 
 (24,'2345678912','a@llll','kkk'),
 (25,'2345678912','a@llll','Kika'),
 (26,'2345678912','a@llll','kkk'),
 (27,'4439246938','lupita_tooL@gmail.com','Lupiis_chiapita'),
 ...
 (46,'6139357512','palo@google.mx','PalomaCanchola'),
 (47,'6139357512','palo@google.mx','PalomaCanchola');
INSERT INTO `dcontacto` (`idC_con`,`tel_con`,`mal_con`,`fbk_con`) VALUES 
 (48,'6139357512','palo@google.mx','PalomaCanchola'),
 (49,'6139357512','palo@google.mx','PalomaCanchola'),
 (50,'6139357512','palo@google.mx','PalomaCanchola'),
 (51,'6139357512','palo@google.mx','PalomaCanchola'),
 (52,'6139357512','palo@google.mx','PalomaCanchola'),
 (53,'6139357512','palo@google.mx','PalomaCanchola'),
 (54,'6139357512','palo@google.mx','PalomaCanchola'),
 (55,'4443289483','lili@yahoo',''),
...
INSERT INTO `dcontacto` (`idC_con`,`tel_con`,`mal_con`,`fbk_con`) VALUES 
 ...
 (84,'4439246938','amerr@jolmd.com',''),
 (85,'4437492740','dooor@jo.com',''),
 ...
 (95,'6666666666','maria@hotmail.com',''),
...
INSERT INTO `mcliente` (`idL_cli`,`nom_cli`,`app_cli`,`apm_cli`,`idC_cli`) VALUES 
 ...
 (12,'a@llll','LOOOO','jo',21),
 (13,'a@llll','LOOOO','jo',22),
 (14,'a@llll','LOOOO','jo',23),
 (15,'a@llll','LOOOO','jo',24),
 (16,'Heladito Holanda','Luu','jo',25),
 (17,'Holanda','LOOOO','jo',26),
 (18,'Maria de Lupita','TuxtlaG','Gutierrezzz',27),
...
INSERT INTO `mcliente` (`idL_cli`,`nom_cli`,`app_cli`,`apm_cli`,`idC_cli`) VALUES 
 ...
 (33,'Paloma','Gonzalez','Canchola',46),
 (34,'Paloma','Gonzalez','Canchola',47),
 (35,'Paloma','Gonzalez','Canchola',48),
 (36,'ClienteIlegal','Gonzalez','Canchola',49),
 (37,'ClienteQuesieslegal','Gonzalez','Canchola',50),
 (38,'ClienteQuesieslegal222','Gonzalez','Canchola',51),
 (39,'ClienteBiencabronLEGAL','Gonzalez','Canchola',52),
 (40,'ClienteBiencabronLEGAL','Gonzalez','Canchola',53),
 (41,'ClienteBiencabronLEGAL','Gonzalez','Canchola',54),
 (42,'Lili','Rodrigez','Manantial',55),
...
INSERT INTO `mespecialista` (`idE_esp`,`nom_esp`,`app_esp`,`apm_esp`,`hrc_esp`,`idU_esp`,`idC_esp`,`idT_esp`) VALUES 
 ...
 (8,'Claudia','Gonzalez','Gonzalez','14:00:00',41,94,10),
 (9,'Maria','Muse','Holanda','15:00:00',42,95,11);
...
INSERT INTO `mgerente` (`idG_gte`,`nom_gte`,`app_gte`,`apm_gte`,`idU_gte`,`idC_gte`) VALUES 
 ...
 (2,'Angela','Gutierrez','Hole',31,84),
 (3,'Isabel','Jimenez','Gonzalez',32,85);
...
INSERT INTO `mrecepcionista` (`idR_rta`,`nom_rta`,`app_rta`,`apm_rta`,`idU_rta`,`idC_rta`) VALUES 
 (2,'Karina','Muse','Recepcionista',10,61),
 (3,'k','k','k',17,68),
 (4,'k','k','k',19,70),
 (5,'j','j','j',20,71),
 (6,'u','u','u',21,72),
...
INSERT INTO `musuario` (`idU_usu`,`nom_usu`,`psw_usu`,`idP_usu`) VALUES 
 ...
 (4,'raul','*3E16155FA1F9A3A7FCAE345D3D6CB236DFD30187',4),
 ...
 (10,'karina','*4C9CD2C64DEC6F9A47B403AE3C345245220DFCE5',1),
 (17,'KON','*894549142A2819BC7952B608F00C489C989212E8',1),
 (19,'mira','*69A7BAE3D37A83849ECEF8F3FF9260B35E01555D',1),
 (20,'j','*9A04E9549880BB91C935B6A3E90DA60E3E5C783F',1),
 (21,'u','*419256D0B4CBC2A2A3EDF9A1983C9FB400938026',1),
 (22,'y','*7446F64EFCFB1294A6DE20CAE7E49C2377A9AA25',1),
...
INSERT INTO `musuario` (`idU_usu`,`nom_usu`,`psw_usu`,`idP_usu`) VALUES 
 ...
 (31,'angela','*D945145B6E0776F621D833B5F507EC90B758FCEA',1),
 (32,'isabel','*5F7780B24BED7C2542E59238BE95934EB48876D6',4),
 (33,'estrellado','*269951431FB142A08B20D9E6D4EECCD829524F72',3),
 (34,'estrella','*36AFDEC2DC2417EF04BA0DF62AA1BEFA11B9F92E',3),
 ...
 (40,'magaly','*6973A932240F2950CCE7B35ACBB5717C3F3ACB86',1),
 (41,'clau','*D8B1F08053E6DC3FF12DF04791842934DE2F7C2A',2),
 (42,'mari','*824C4E86F83457CAB59EF52B8ED0BF4DAC7CAD40',2);
