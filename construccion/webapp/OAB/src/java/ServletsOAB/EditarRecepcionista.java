 ...
 * @author Job
 */
public class EditarRecepcionista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Editar datos de recepcionista</title>");
                ...
                if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                    if(tRecepcionistas > 0) {
                        for(int i=0 ; i<tRecepcionistas ; i++) {
                            nomUsuario = recepcionistas.get(i).getNomUsuario();
                            nomRecepcionista = recepcionistas.get(i).getNombre();
                            apellidoPaterno = recepcionistas.get(i).getApellidoPaterno();
                            apellidoMaterno = recepcionistas.get(i).getApellidoMaterno();
                            telefono = recepcionistas.get(i).getTelefono();
                            email = recepcionistas.get(i).getEmail();
                            facebook = recepcionistas.get(i).getFacebook();
                            out.println("<h3>Modificar datos de la recepcionista: '" + nomRecepcionista + "'</h3>");
                                out.println("<br/>");
                    ...
                    // Momentos después de que este usuario haya consultado sus datos, en tal caso aparecerá este mensaje:
                        ...
                        out.println("<input type='text' id='nomRecepcionista' name='nomRecepcionista' autocomplete='on' placeholder='Introducir nombre' required>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(EditarRecepcionista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
