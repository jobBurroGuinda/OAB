    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Cancelar cita</title>");   
                ...
                out.println("<div class='container'>");
                    ...
                    if(privilegioOAB.equals(privRecepcionista) || privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                        out.println("<h2>¿En verdad desea cancelar la cita?</h2>");
                        out.println("<table>");
                        ...
                        out.println("</table>");
                        out.println("   <a class='button fit special' href='VerificarCancelacion?idCita=" + idCita + "'>Aceptar</a>");
