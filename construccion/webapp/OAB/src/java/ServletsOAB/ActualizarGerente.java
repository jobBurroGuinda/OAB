...
public class ActualizarGerente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            if(privilegioOAB.equals(privAdmin)) {
                ...
                nomGerente = request.getParameter("nombres");
                ...
                for(int i=0 ; i<tGerentes ; i++) {
                    ...
                    verificadorAct = cn.actualizarGerenteA(idUsuario, nomUsuario, password,
                            idPrivilegio, idGerente, nomGerente, apellidoPaterno, apellidoMaterno, idContacto, telefono, email, facebook);
            }
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Actualizar gerente</title>");
                ...
                if(privilegioOAB.equals(privAdmin)) {
                    ...
                    if(verificadorAct != true) {
                                out.println("<h3>Actualizar gerente: '" + nomGerente + "'</h3>");
                    ...
                    // De lo contrario..., si los datos del cliente se actualizaron correctamente
                        ...
                        sesion.setAttribute("DatosGerente", gerentes);
                            if(!gerentes.isEmpty()) {
                                ...
                                out.println("</form>");
                                out.println("<h1 style='color:green;'>Los datos del gerente se han actualizado exitosamente</h1>");
                                    ...
                                    if(gerentes.get(i).getIdPersona() == idGerente) {
                                            ...
                                            out.println("</tr>");
                                                out.println("<tr>");
                                                    ...
                                                    String privR = gerentes.get(0).getPrivilegio();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ActualizarGerente.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
