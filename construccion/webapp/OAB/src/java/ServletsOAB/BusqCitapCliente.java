 ...
 * @author Job
 */
public class BusqCitapCliente extends HttpServlet {
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                if(privilegioOAB.equals(privRecepcionista) || privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin) || 
                    ...
                    out.println("<h2>Buscar citas por cliente</h2>");
                    out.println("<h3>AppointmentBook</h3>");
                    out.println("<p>Cuando inicies sesión se te mostrarán automáticamente las citas programadas para ese día<br />");
                    out.println("¿Qué opinas?</p>");
                } else {
