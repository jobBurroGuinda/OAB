 ...
 * @author Job
 */
public class BuscarClientepCita extends HttpServlet {
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                if(privilegioOAB.equals(privRecepcionista) || privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin) ||  
                    ...
                    out.println("<input type='text' id='nomCliente' name='nomCliente' autocomplete='on' placeholder='Introducir nombre'>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BuscarClientepCita.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
