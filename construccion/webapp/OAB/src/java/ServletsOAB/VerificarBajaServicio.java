 ...
 * @author Job
 */
public class VerificarBajaServicio extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null) {
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Baja del servicio</title>");   
                ...
                out.println("<br/>");
                    ...
                    if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                        ...
                        verificador = cn.eliminarServicio(idServicio);
                        // Si la cita se cancela correctamente...
                        if(verificador != false) {
                            out.println("<h2 style='color:green;'>El servicio seleccionado se eliminó exitosamente, junto con las citas que se le programaron</h2>");
                            out.println("<a class='button fit special' href='VerServicios'>Regresar a los servicios</a>");
                        }
                        // Si la cita no se pudo cancelar...
                        else {
                            out.println("<h2 style='color:red;'>El servicio no se pudo dar de baja. Intente de nuevo, si persiste el problema contácte al desarrollador de la aplicación.</h2>");
                            out.println("<table>");
                            ...
                            out.println("</table>");
                            out.println("   <a class='button fit special' href='VerificarBajaServicio?idServicio=" + idServicio + "'>Volver a intentar</a>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(VerificarBajaServicio.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
