 ...
 * @author Job
 */
public class NvoAdmin extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            String nombreAdmin = "";
                if(request.getParameter("nombreAdmin") != null) {
                    nombreAdmin = request.getParameter("nombreAdmin");
                }
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Nuevo administrador</title>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(NvoAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
