 ...
 * @author Job
 */
public class BuscarGerente extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            try (PrintWriter out = response.getWriter()) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Buscar gerente</title>");
                ...
                if(privilegioOAB.equals(privAdmin)){
                    ...
                    out.println("<input type='text' id='nomGerente' name='nomGerente' autocomplete='on' placeholder='Introducir nombre'>");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BuscarGerente.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
