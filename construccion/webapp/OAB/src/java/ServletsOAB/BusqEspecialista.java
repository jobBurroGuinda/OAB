 ...
 * @author Job
 */
public class BusqEspecialista extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sesion != null){
            ...
            String nomEspecialista = request.getParameter("nomEspecialista");
            try (PrintWriter out = response.getWriter()) {
                String privilegio = null;
                out.println("<!DOCTYPE html>");
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Buscar especialista</title>");
                ...
                // Inicio del encabezado
                        ...
                        if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                            ...
                            out.println("           </li>");
                            out.println("           <li>");
                            out.println("               <a href='#'>Especialistas en belleza</a>");
                            out.println("               <ul>");
                            ...
                            out.println("       <li><a href='BuscarServicio'>Buscar</a></li>");
                            out.println("   </ul>");
                            out.println("</li>");
                        }
                        out.println("</ul>");
                ...
                if(privilegioOAB.equals(privGerente) || privilegioOAB.equals(privAdmin)){
                    ...
                    if(privilegioOAB.equals(privGerente)) {
                        especialistas = cn.buscarEspecialista(nomEspecialista);
                    } else if(privilegioOAB.equals(privAdmin)) {
                        especialistas = cn.buscarEspecialistaA(nomEspecialista);
                    }
                    
                    sesion.setAttribute("DatosEspecialista", especialistas);
                    int tEspecialistas = especialistas.size();
                    out.println("<h2>Buscar especialista</h2>");
                    out.println("<form method='POST' action='BusqEspecialista'>");
                    out.println("<input type='text' id='nomEspecialista' name='nomEspecialista' autocomplete='on' placeholder='Introducir nombre' value='" + nomEspecialista + "' required>");
                    ...
                    out.println("<table>");
                        ...
                        out.println("<tr>");
                            String nombre = p.obtenerNomCompleto(especialistas.get(i).getNombre(), especialistas.get(i).getApellidoPaterno(), especialistas.get(i).getApellidoMaterno());
                            out.println("   <td>" + nombre + "</td>");
                            out.println("   <td><a class='button special small' href='DetallesEspecialista?idEspecialista=" + especialistas.get(i).getIdPersona() + "'>Detalles</a></td>");
                            out.println("   <td><a class='button special small' href='EditarEspecialista?idEspecialista=" + especialistas.get(i).getIdPersona() + "'>Editar</a></td>");
                                out.println("   <td><a class='button special small' href='BajaEspecialista?idEspecialista=" + especialistas.get(i).getIdPersona() + "'>Baja</a></td>");
                        out.println("</tr>");
                        }
                        out.println("</table>");
                    } else{
                        out.println("<h2>El especialista \"" + nomEspecialista + "\", no se encuentra registrado</h2>");
                        out.println("<h3><a class='button fit' href='NvoEspecialista?nombreEspecialista="+ nomEspecialista +"'>Clic aquí para registrar</a></h3>");
                    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(BusqEspecialista.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
